...
class from_tsv_to_sql ():
    def titleEpisode_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/titleEpisode.csv",encoding='utf-8-sig' , index=False)
    def titleAkas_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/titleAkas.csv",encoding='utf-8-sig' , index=False)
    def titleBasics_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/titleBasics.csv",encoding='utf-8-sig' , index=False)
    def titleCrew_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/titleCrew.csv",encoding='utf-8-sig' , index=False)
    def titleRatings_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/titleRatings.csv",encoding='utf-8-sig' , index=False)
    def nameBasics_cleanup() :
        ...
        final_dataframe.to_csv("F:/taklif/cleaned_up/nameBasics.csv",encoding='utf-8-sig',index=False)
    def titlePrincipals_cleanup() :
        df = pd.read_csv ("titlePrincipals.tsv", chunksize=500000 ,low_memory=False,sep= "\t")
        for chunk in df :       
            chunk.to_csv("F:/taklif/cleaned_up/titlePrincipals.csv",encoding='utf-8-sig' , index=False)
